...
export const FormField: React.FC<FormFieldProps> = ({title, type = 'text', placeholder = '', className = '', value, onChange, id, name, error, iconCode}) => {
  ...
  return (
    <div className="field">
          ...
          <div className="control has-icons-left has-icons-right">
            <input className={`input ${useDangerClassName} ${className}`}
                   id={id}
                   name={name}
                   type={type}
